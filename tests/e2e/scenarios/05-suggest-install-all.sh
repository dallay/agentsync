...
assert_file_contains "install-all.txt" "Installing 15 recommended skills..."
...
assert_file_contains "install-all.txt" "installed python-executor"
assert_file_contains "install-all.txt" "installed python-testing-patterns"
assert_file_contains "install-all.txt" "Recommendation install summary"
assert_file_contains "install-all.txt" "Installed: 15"
...
assert_file_contains "install-all-repeat.txt" "already installed python-executor"
assert_file_contains "install-all-repeat.txt" "already installed python-testing-patterns"
...
assert_file_contains "install-all-repeat.txt" "Already installed: 15"
