...
If you want, I can also add an example SKILL.md template file under `website/docs/src/content/docs/examples/` or add a playground page showing install flows. Tell me if you want that and I’ll add it.
