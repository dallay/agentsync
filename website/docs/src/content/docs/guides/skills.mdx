...
The **[dallay/agents-skills](https://github.com/dallay/agents-skills)** repository is the canonical home for all skills maintained by the AgentSync team. These include accessibility, docker-expert, github-actions, rust-async-patterns, and many more.
...
For skills without a catalog entry, AgentSync falls back to the skills.sh search API.
