...
Edit `.agents/agentsync.toml` to define which assistants you use. By default, it includes configurations for Claude Code, GitHub Copilot, Cursor, Codex CLI, Gemini CLI, OpenCode, and a root AGENTS.md target.
