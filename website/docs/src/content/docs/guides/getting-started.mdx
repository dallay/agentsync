...
When run interactively, `agentsync init` also asks whether to install the bundled AgentSync skill
at `.agents/skills/agentsync/SKILL.md`.

For automation/non-interactive usage, you can control behavior explicitly:
