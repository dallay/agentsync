...
For field-by-field details, see the <BaseLink href="/reference/configuration/#gitignore-management">configuration reference</BaseLink>. For command semantics, see the <BaseLink href="/reference/cli/#apply">CLI reference</BaseLink>. For hook-manager and native Git hook examples, see <BaseLink href="/guides/git-hook-automation/">Git Hook Automation</BaseLink>.
