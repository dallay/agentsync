...
**Options**:
- `-p, --path <PATH>`, `--project-root <PATH>`: Project root directory (defaults to current dir).
...
**Options**:
- `-p, --path <PATH>`, `--project-root <PATH>`: Project root directory.
...
**Flags**:
- `-p, --path <PATH>`, `--project-root <PATH>`: Path to the project root.
