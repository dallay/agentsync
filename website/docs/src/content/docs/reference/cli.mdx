...
Manage installable AI agent skills from `dallay/agents-skills`, external GitHub repositories, or local sources, with `skills.sh` used as a fallback search mechanism.
