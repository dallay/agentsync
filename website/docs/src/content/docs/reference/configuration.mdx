...
**Note on Automatic Ignoring**: AgentSync also automatically ignores backup files (e.g., `*.bak`, `*.bak.*`) for both managed targets and skills to keep your repository clean during migrations and updates.
