...
**Note on Automatic Ignoring**: AgentSync automatically adds ignore patterns for backup files to keep your repository clean. These patterns are specific to the type of content:
- **Managed targets**: `<destination>.bak.*` (e.g., `CLAUDE.md.bak.20250101`)
- **Skills**: `.agents/skills/*.bak` (defensive pattern for skill migrations)
