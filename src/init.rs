...
# config files for each AI agent (Claude, Copilot, Codex, Cursor, Gemini, MiniMax Code, VS Code,
# OpenCode, and Z-Code).
#
# [mcp]
# enabled = true
...
#   - type: "symlink", "symlink-contents", or "module-map"
...
# MiniMax Code
# -----------------------------------------------------------------------------
# MiniMax Code natively consumes the canonical .agents/skills and root AGENTS.md
# locations, so no redundant skill or instruction targets are needed here.
[agents.minimax]
enabled = true
description = "MiniMax Code - MiniMax's AI coding assistant"

# -----------------------------------------------------------------------------
# Z-Code
# -----------------------------------------------------------------------------
# Z-Code natively consumes the canonical .agents/skills and root AGENTS.md
# locations. MCP servers are generated into .zcode/config.json when enabled.
[agents.zcode]
enabled = true
description = "Z-Code - Z.ai's AI coding assistant"

[agents.zcode.targets.commands]
source = "commands"
