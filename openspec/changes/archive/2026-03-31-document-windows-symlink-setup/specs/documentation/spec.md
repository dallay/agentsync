...
(Previously: Documentation for gitignore team workflows had to keep Windows-specific guidance minimal within shared workflow content, use short callouts or links to targeted platform guidance when needed, and remain cross-platform without creating a second Windows-specific workflow narrative.)
